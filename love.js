(function(window){
    ...
    Heart = function() {
        ...
        for (var i = 10; i < 30; i += 0.2) {
            ...
            y = 19 * Math.cos(t) - 5 * Math.cos(2 * t) - 2 * Math.cos(3 * t) - Math.cos(4 * t);
    ...
    Seed.prototype = {
        ...
        drawText: function() {
            ...
            ctx.fillText("Click the heart:) ", 80, -10);
            ctx.fillText("Birthday Queen !", 80, 10);
            ctx.restore();
        },
        clear: function() {
            var ctx = this.tree.ctx, cirle = this.cirle;
    ...
    Tree.prototype = {
        ...
        createBloom: function(width, height, radius, figure, color, alpha, angle, scale, place, speed) {
            var x, y;
            while (true) {
                x = random(120, width - 20);
                y = random(120, height - 20);
